...
<div class="menu-container">
    ...
    <div class="menu-section">
        ...
        <div class="menu-item">
            <div class="menu-title">
                <span>Coca Cola 0,3 l</span><span class="price">3,80 €</span>
            </div>
            <div class="menu-title">
                <span>Coca Cola 0,5 l</span><span class="price">4,80 €</span>
            </div>
        </div>
        <div class="menu-item">
            <div class="menu-title">
                <span>Mezzo Mix 0,3 l</span><span class="price">3,80 €</span>
            </div>
            <div class="menu-title">
                <span>Mezzo Mix 0,5 l</span><span class="price">4,50 €</span>
            </div>
        </div>
        <div class="menu-item">
            <div class="menu-title">
                <span>Sprite 0,3 l</span><span class="price">2,50 €</span>
            </div>
            <div class="menu-title">
                <span>Sprite 0,5 l</span><span class="price">3,20 €</span>
            </div>
        </div>
        <div class="menu-item">
            <div class="menu-title">
                <span>Orangensaft 0,3 l</span><span class="price">2,50 €</span>
            </div>
            <div class="menu-title">
                <span>Orangensaft 0,5 l</span><span class="price">3,20 €</span>
            </div>
        </div>
        <div class="menu-item">
            <div class="menu-title">
                <span>Bier Pils 0,3 l</span><span class="price">4,80 €</span>
            </div>
            <div class="menu-title">
                <span>Bier Pils 0,5 l</span><span class="price">4,80 €</span>
            </div>
        </div>
        <div class="menu-item">
            <div class="menu-title">
                <span>Radler Alkoholfrei 0,3 l</span><span class="price">4,50 €</span>
            </div>
            <div class="menu-title">
                <span>Radler Alkoholfrei 0,5 l</span><span class="price">4,50 €</span>
            </div>
        </div>
        <div class="menu-item">
            <div class="menu-title">
                <span>Colaweizen 0,3 l</span><span class="price">3,20 €</span>
            </div>
            <div class="menu-title">
                <span>Colaweizen 0,5 l</span><span class="price">3,20 €</span>
            </div>
        </div>
        <div class="menu-item">
            <div class="menu-title">
                <span>Fanta 0,3 l</span><span class="price">3,80 €</span>
            </div>
            <div class="menu-title">
                <span>Fanta 0,5 l</span><span class="price">4,80 €</span>
            </div>
        </div>
        <div class="menu-item">
            <div class="menu-title">
                <span>Hefeweizen 0,3 l</span><span class="price">3,80 €</span>
            </div>
            <div class="menu-title">
                <span>Hefeweizen 0,5 l</span><span class="price">4,80 €</span>
            </div>
        </div>
        <div class="menu-item">
            <div class="menu-title">
                <span>Apfelschorle 0,3 l</span><span class="price">2,50 €</span>
            </div>
            <div class="menu-title">
                <span>Apfelschorle 0,5 l</span><span class="price">3,20 €</span>
            </div>
        </div>
    </div>
